    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, background: 'var(--bg)' }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 32, letterSpacing: '0.02em', marginBottom: 8 }}>CREATE ACCOUNT</h1>
          <p style={{ color: 'var(--text-muted)', fontSize: 14 }}>Start your fitness transformation today</p>
        </div>
